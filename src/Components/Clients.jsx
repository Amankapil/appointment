...
import IndianClient from "./bookingcomp/dashboard/IndianClient";
import OverseasClient from "./bookingcomp/dashboard/OverseasClient";
const tabs = [
  {
    name: "Indian Residents",
    icon: (
      <svg
        width="21"
        height="20"
