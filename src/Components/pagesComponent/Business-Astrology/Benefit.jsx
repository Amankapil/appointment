...
export default function Benefit() {
  return (
    <div className="bg-[#F5F0EB] text-[#1E1E1E] min-h-screen p-10 max-md:p-4 my-10">
      ...
      <div className="flex items-center justify-center flex-wrap gap-4 pb-7">
        ...
        >
          ...
          <div className="text-center flex items-center justify-center mt-4 gap-3">
            ...
            <p className="text-2xl font-normal text-[#4D4D4D] font-inter text-left gap-3 max-md:text-[18px]">
              <span className="text-[#000]">Entrepreneurs & Startups —–</span>{" "}
              Evaluate investors, partners, or market timing.
            </p>
          </div>
        </div>
        <div
        ...
        >
          ...
          <div className="text-center flex items-center justify-center mt-4 gap-3">
            ...
            />
            <p className="text-2xl font-normal text-[#4D4D4D] font-inter text-left gap-3 max-md:text-[18px]">
              <span className="text-[#000]">Business Owners —– </span> Decide on
              suppliers, clients, or big purchases.
            </p>
          </div>
        </div>
        <div
        ...
        >
          ...
          <div className="text-center flex items-center justify-center mt-4 gap-3">
            ...
            />{" "}
            <p className="text-2xl font-normal text-[#4D4D4D] font-inter text-left gap-3 max-md:text-[18px]">
              <span className="text-[#000]">Traders & Investors —</span> Time
        ...
        >
          ...
          <div className="text-center flex items-center justify-center mt-4 gap-3">
            ...
            />{" "}
            <p className="text-2xl font-normal text-[#4D4D4D] font-inter text-left gap-3 max-md:text-[18px]">
              <span className="text-[#000]">Corporate Executives —–</span> Test
              strategies before committing resources.
            </p>
          </div>
        </div>
      </div>
