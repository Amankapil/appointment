  ...
  return (
    <>
      <div className="breaking my-10 max-xl:px-6">
        <h1 className="text-[56px] max-lg:text-[40px]  text-[#4D4D4D] text-center font-salernomi w-[100%] font-normal mb-6">
        ...
        <div className="lis  max-lg:p-8  max-w-[846px] py-10 mx-auto space-y-4">
          ...
          >
            ...
            <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
              Waiting for childbirth, yet facing repeated delays?{" "}
          ...
          >
            ...
            <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
              Miscarriages or health issues causing anxiety?
            </p>
          </div>
          ...
          >
            ...
            <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
              Parenting conflicts – discipline, education, lifestyle choices?{" "}
            </p>
          </div>
          ...
          >
            ...
            <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
              Children struggling with studies, friendships, or emotional
              health?{" "}
            </p>
          </div>
          ...
          >
            ...
            <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
              Constant interference from in-laws or relatives in family matters?{" "}
            </p>
          </div>
          <div
            style={{ boxShadow: "0px 0px 24px 2px #AC8C6066 inset" }}
          ...
          >
            ...
            <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
              Sibling rivalry or lack of harmony at home?{" "}
            </p>
          </div>
        </div>
        <div className="flex items-center flex-col w-[100%] mt-8  justify-center text-center">
          <p className="text-xl font-inter text-[#4D4D4D] mb8 w-1/2 max-xl:w-full ">
            If this sounds familiar, you’re not alone. Families across
            generations face these struggles — and astrology can reveal the
            Karmic reasons behind them.
          </p>
        </div>
        <div className="flex items-center flex-col w-[100%] mt-8  justify-center text-center">
          <Link
