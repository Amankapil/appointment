...
export default function Trust() {
  return (
    <div className="bg-[#F5F0EB] text-[#1E1E1E] min-h-screen p-10 py-20 max-md:p-4">
      ...
      <div className="flex items-center justify-center flex-wrap gap-4 pb-7">
        ...
        >
          ...
          <div className="text-center flex items-center justify-center mt-4 gap-3">
            ...
            <p className="text-2xl font-normal text-[#4D4D4D] font-inter text-left gap-3 max-md:text-[18px]">
              <span className="text-[#000]">Beyond Rituals —– </span> we provide
              guidance, not fear-driven remedies.
            </p>
          </div>
        </div>
        <div
        ...
        >
          ...
          <div className="text-center flex items-center justify-center mt-4 gap-3">
            ...
            />
            <p className="text-2xl font-normal text-[#4D4D4D] font-inter text-left gap-3 max-md:text-[18px]">
              <span className="text-[#000]">Practical + Spiritual</span> —
              clarity you can apply daily with compassion.
            </p>
          </div>
        </div>
        <div
          ...
          <div className="text-center flex items-center justify-center mt-4 gap-3">
            ...
            <p className="text-2xl font-normal text-[#4D4D4D] font-inter text-left gap-3 max-md:text-[18px]">
              <span className="text-[#000]">
                Respect for Every Family Journey –{" "}
              </span>{" "}
              single parents, joint families, intercultural families all paths
              are divine.
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div className="text-center flex items-center justify-center mt-4 gap-3">
            ...
            <p className="text-2xl font-normal text-[#4D4D4D] font-inter text-left gap-3 max-md:text-[18px]">
              ...
              years, 5,000+ consultations delivered
            </p>
          </div>
        </div>
      </div>
