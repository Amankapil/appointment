...
const faqs = [
  {
    question: "Can astrology predict success in exams?",
    answer: `Yes, astrology shows strong and weak periods for performance. It can’t replace hard work but guides preparation.`,
    audio: "/EducationFAQ/A-1.mp3",
  },
  {
    question: "Why does my child study hard but still fail?",
    answer:
      "Sometimes karmic factors affect focus or timing. Astrology highlights these and shows when improvement comes.",
    audio: "/EducationFAQ/A-2.mp3",
  },
  {
    question: "Can astrology help choose the right career?",
    answer:
      "Absolutely. Charts reveal natural strengths, suitable subjects, and long-term career paths.",
    audio: "/EducationFAQ/A-3.mp3",
  },
  {
    question: "Is studying abroad shown in astrology?",
    answer:
      "Yes, many charts clearly show opportunities for overseas education and settlement.",
    audio: "/EducationFAQ/A-4.mp3",
  },
  {
    question: "Why is my child intelligent but distracted?",
    answer: `Distractions often come from planetary influences. Astrology helps understand and counter them.`,
    audio: "/EducationFAQ/A-5.mp3",
  },
  {
    question: "Can astrology guide competitive exams?",
    answer:
      "Yes, it shows favorable exam periods and helps plan attempts wisely.",
    audio: "/EducationFAQ/A-6.mp3",
  },
  {
    question: "Does astrology help with motivation?",
    answer:
      "Yes, it identifies mental blocks and periods of low energy. With awareness, effort becomes smoother.",
    audio: "/EducationFAQ/A-7.mp3",
  },
  {
    question: "My child is a slow learner. Can astrology help?",
    answer:
      " Astrology highlights learning style. With right support and timing, progress always comes.",
    audio: "/EducationFAQ/A-8.mp3",
  },
  {
    question: "Should parents also be consulted along with students?",
    answer: `Yes, because parental expectations and support deeply affect students.`,
    audio: "/EducationFAQ/A-9.mp3",
  },
  {
    question: "Can astrology replace effort in studies? ",
    answer:
      "Never. Astrology guides and supports — but discipline, focus, and effort are essential.",
    audio: "/EducationFAQ/A-10.mp3",
  },
];
