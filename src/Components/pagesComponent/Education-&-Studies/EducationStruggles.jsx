      ...
      <div className="breaking mt-10">
        ...
        <div className="lis  max-lg:p-8  max-w-[846px] mx-auto space-y-4">
          ...
          >
            ...
            <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
              Lack of concentration or motivation despite effort?
          ...
          >
            ...
            <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
              Exam fear or repeated failure in competitive tests?{" "}
            </p>
          </div>
          ...
          >
            ...
            <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
              Confusion about which career path to choose?{" "}
            </p>
          </div>
          ...
          >
            ...
            <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
              Parents worried about children’s academic performance?
            </p>
          </div>
          <div
            style={{ boxShadow: "0px 0px 24px 2px #AC8C6066 inset" }}
          ...
          >
            ...
            <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
              Uncertainty about studying abroad — is it the right move?{" "}
            </p>
          </div>
          <div
            style={{ boxShadow: "0px 0px 24px 2px #AC8C6066 inset" }}
          ...
          >
            ...
            <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
              Bright in childhood but losing focus as studies progress?{" "}
            </p>
          </div>
        </div>
        <div className="flex items-center flex-col w-[100%] mt-8  justify-center text-center">
          <p className="text-xl font-inter text-[#4D4D4D] mb8 w-1/2 max-md:w-full ">
            These struggles are common. Astrology helps uncover why they happen
            and what steps can support learning success.
          </p>
        </div>
        <div className="flex items-center flex-col w-[100%] mt-8  justify-center text-center">
          <Link
          ...
          >
            See How Astrology Can Guide You{" "}
          </Link>{" "}
        </div>
      </div>
    </>
...
export default EducationStruggles;
