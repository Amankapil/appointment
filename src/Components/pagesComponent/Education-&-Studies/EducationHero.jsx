...
export default function EducationHero() {
  return (
    <div className="bg-[#F5F0EB] text-[#1E1E1E] min-hscreen p-10 max-md:p-4 py-20">
      ...
      <div className="img h-[400px] max-md:h-full bgwhite flex items-center justify-center py-10">
        <Image
          width={900}
          height={500}
          loading="lazy"
          src="/images/Frame 337 copy 4.png"
          alt="j"
        />
      </div>
      <div className="pr-4 max-lg:flex-wrap flex flex-col font-inter justify-center items-center mt-4 ">
        <p className="font-normal text-lg text-[#4D4D4D] w-1/2 max-lg:w-full  text-center">
          Astrology that reveals learning patterns, exam timing, and success in
          studies. Are you (or your child) struggling with focus, results, or
          the right career choice? Astrology can uncover hidden learning
