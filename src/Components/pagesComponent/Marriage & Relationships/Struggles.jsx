  ...
  return (
    <>
      <div className="breaking my-10">
        ...
        <div className="lis  max-lg:p-8  max-w-[846px] mx-auto space-y-4 my-10">
          <div
          ...
          >
            ...
            <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
              Endless fights about ego or decision-making leaving you drained?
          ...
          >
            ...
            <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
              In-laws or family expectations creating pressure in your
              relationship?
            </p>
          </div>
          ...
          >
            ...
            <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
              Marriage delayed, with uncertainty about “when” it will happen?
            </p>
          </div>
          ...
          >
            ...
            <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
              Arguments about money, lifestyle, or children’s future?{" "}
            </p>
          </div>
          ...
          >
            ...
            <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
              Suspicion, checking phones, or comparisons causing trust issues?{" "}
            </p>
          </div>
          <div
            style={{ boxShadow: "0px 0px 24px 2px #AC8C6066 inset" }}
          ...
          >
            ...
            <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
              Confused whether love or arranged marriage is right for you?{" "}
            </p>
          </div>
        </div>
