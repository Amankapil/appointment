...
export default function Challenges() {
  return (
    <div className="bg-[#fff] text-[#1E1E1E] min-hscreen p-10 max-md:p-4 mt-20 max-w-[1350px] mx-auto">
      ...
      <div className="pr-4 max-lg:flex-wrap flex flex-col font-inter justify-center items-center mt-4 ">
        ...
        <div className="flex flex-wrap gap-10 items-center justify-start py-10">
          <div className="card1 gap-1 flex items-center w-[380px] max-md:w-full justify-start">
            ...
            <h1 className="text-[22px] max-md:text-[20px] text-[#101010] text-center font-salernomi w[100%] max-md:w-full font-normal ">
              Power struggles draining love and respect{" "}
            </h1>
          </div>
          <div className="card1 gap-1 flex items-center w-[380px] max-md:w-full justify-start">
            <svg
            ...
            <h1 className="text-[22px] max-md:text-[20px] text-[#101010] text-center font-salernomi w[100%] max-md:w-full font-normal ">
              Conflicting life purposes and values{" "}
            </h1>
          </div>
          <div className="card1 gap-1 flex items-center w-[380px] max-md:w-full justify-start">
            <svg
          ...
          <div className="card1 gap-1 flex items-center w-[380px] max-md:w-full justify-start">
            ...
            <h1 className="text-[22px] max-md:text-[20px] text-[#101010] text-center font-salernomi w[100%] max-md:w-full font-normal ">
              Financial stress and lifestyle gaps{" "}
            </h1>
          </div>
          <div className="card1 gap-1 flex items-center w-[380px] max-md:w-full justify-start">
            <svg
            ...
            <h1 className="text-[22px] max-md:text-[20px] text-[#101010] text-center font-salernomi w[100%] max-md:w-full font-normal ">
              Trust issues, suspicion, or comparisons{" "}
            </h1>
          </div>
          <div className="card1 gap-1 flex items-center w-[380px] max-md:w-full justify-start">
            <svg
        ...
        <h1 className="text-[32px] max-md:text-[24px] py-5 text-[#4D4D4D] text-center font-salernomi w-[60%] max-md:w-full font-normal mb-6">
          Every relationship is unique. Our readings reveal the deeper causes of
          conflict — and the divine ways to overcome them.
        </h1>
      </div>
    </div>
  );
