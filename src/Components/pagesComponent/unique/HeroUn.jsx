        ...
        <div className="pr-4 max-lg:flex-wrap flex flexcol font-inter gap-10 justify-center items-start my-10 ">
          ...
          <div className="w-1/2 max-lg:w-full">
            <p className="font-normal text-lg text-[#4D4D4D] w  text-left">
              ...
              Prashna Jyotishya, delivering precise answers without requiring
              your birth details. Unlike traditional astrology, which relies on
              a static birth chart, we cast a{" "}
              <span className="text-[#000]"> dedicated Prashna Kundali</span>{" "}
              for each question you ask. This dynamic approach reveals hidden
              secrets and allows for a
