    ...
    <div className="bg-[#F5F0EB] text-[#1E1E1E] min-hscreen p-10 max-md:p-4">
      <div className="heading flex mb-10 flex-col items-center justify-center">
        <h1 className="text-[64px] max-md:text-[40px] text-[#4D4D4D] text-center font-salernomi w-[60%] max-lg:w-full font-normal mb-6">
          Understand Your Health Through Astrology{" "}
        </h1>
        <svg
          width="49"
          height="24"
      ...
      <div className="pr-4 max-lg:flex-wrap flex flex-col font-inter justify-center items-center mt-4 ">
        <p className="font-normal text-lg text-[#4D4D4D] w-1/2 max-lg:w-full  text-center">
          <span className="text-[#000]"></span> Find balance, prevention, and
          peace with holistic astrological guidance. Are recurring health issues
          or stress affecting your life? Astrology offers clarity beyond medical
          reports giving you spiritual and karmic insights into your well-being.
