    ...
    <div className="bg-[#fff] text-[#1E1E1E] min-hscreen p-10 py-20 max-md:p-4">
      <div className="heading flex mb-10 flex-col items-center justify-center">
        <h1 className="text-[64px] max-md:text-[40px] text-[#4D4D4D] text-center font-salernomi w-[60%] max-xl:w-full font-normal mb-6">
          How Astrology Supports Your Health Journey
        </h1>
        <svg
          width="49"
          height="24"
      ...
      <div className="pr-4 max-lg:flex-wrap flex flex-col font-inter justify-center items-center mt-4 ">
        <p className="font-normal text-lg text-[#4D4D4D] w-1/2 max-lg:w-full  text-center">
          <span className="text-[#000]"></span>At Prashna Siddhi, we see health
          as more than just the body. Our approach integrates cosmic patterns,
          karma, and personal discipline. With our guidance, you can:
        </p>
      </div>
      ...
      <div className="lis  max-lg:p-8  pt-10 max-w-[846px] mx-auto space-y-4">
        ...
        >
          ...
          <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
            Understand recurring health issues from a karmic perspective.{" "}
        ...
        >
          ...
          <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
            Identify vulnerable periods and take preventive steps.
          </p>
        </div>
        ...
        >
          ...
          <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
            Find balance between medical treatments and spiritual alignment.{" "}
          </p>
        </div>
        ...
        >
          ...
          <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
            Learn simple lifestyle practices that align with your planetary
            strengths.{" "}
          </p>
        </div>
        ...
        >
          ...
          <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
            Reduce anxiety by knowing “why” certain struggles occur.
          </p>
        </div>
      </div>
