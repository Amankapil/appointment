        ...
        <div className="lis  max-lg:p-8  max-w-[846px] mx-auto space-y-4">
          ...
          >
            ...
            <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
              Health problems with no clear medical explanation?
          ...
          >
            ...
            <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
              Repeated illnesses or slow recovery draining your energy?{" "}
            </p>
          </div>
          ...
          >
            ...
            <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
              Stress, anxiety, or insomnia affecting your quality of life?{" "}
            </p>
          </div>
          ...
          >
            ...
            <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
              Fear of hereditary conditions or chronic issues?
            </p>
          </div>
          ...
          >
            ...
            <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
              Confusion about diet, lifestyle, or healing paths?{" "}
            </p>
          </div>
          <div
            style={{ boxShadow: "0px 0px 24px 2px #AC8C6066 inset" }}
          ...
          >
            ...
            <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
              Feeling “stuck” in cycles of poor health and low vitality?{" "}
            </p>
          </div>
        </div>
