...
const faqs = [
  {
    question: "Can astrology cure diseases?",
    answer: `No. Astrology does not cure. It reveals karmic patterns behind health issues, helping you combine medical care with inner balance.`,
    audio: "/healthFAQ/A-1.mp3",
  },
  {
    question: "Why do illnesses keep recurring?",
    answer:
      "Often due to karmic lessons. Astrology shows when and why such cycles appear, so you can prepare and manage them better.",
    audio: "/healthFAQ/A-2.mp3",
  },
  {
    question: "Can astrology predict health problems in advance?",
    answer:
      "Yes, astrology highlights vulnerable periods. Awareness helps in prevention and lifestyle adjustments.",
    audio: "/healthFAQ/A-3.mp3",
  },
  {
    question: "Should I stop medical treatment and only follow astrology?",
    answer:
      "Never. Astrology supports healing but does not replace doctors. Both work together for your well-being.",
    audio: "/healthFAQ/A-4.mp3",
  },
  {
    question:
      "Can astrology guide mental health struggles like anxiety or depression?",
    answer: `Yes, it reveals planetary influences on the mind and suggests spiritual practices for stability. Medical support is equally important.`,
    audio: "/healthFAQ/A-5.mp3",
  },
  {
    question: "How does Prashna help in sudden health issues? ",
    answer:
      "Prashna Kundali gives immediate insight into urgent health questions — like recovery, timing, or hidden causes.",
    audio: "/healthFAQ/A-6.mp3",
  },
  {
    question: "Can astrology help with diet or lifestyle?",
    answer:
      "Yes. Charts reveal tendencies that support or weaken health. Aligning habits with planetary strengths promotes balance.",
    audio: "/healthFAQ/A-7.mp3",
  },
  {
    question: "Is illness always a punishment for past karma?",
    answer:
      "Not punishment — but often karmic lessons for growth. Astrology helps you see illness as a teacher, not an enemy.",
    audio: "/healthFAQ/A-8.mp3",
  },
  {
    question: "What if hereditary diseases are shown in charts? ",
    answer: `Awareness is power. Astrology prepares you with preventive care and resilience.`,
    audio: "/healthFAQ/A-9.mp3",
  },
  {
    question: "Can astrology ensure a long, healthy life?",
    answer:
      "No guarantees. Astrology shows tendencies and timings. Living with balance, faith, and discipline ensures the best outcome.",
    audio: "/healthFAQ/A-10.mp3",
  },
];
        ...
        <div className="max-w-7xl bg-[#F0EDE9] mx-auto py10">
          <div className="heading flex mb-10 flex-col items-center justify-center">
            <h1 className="text-[36px] md:text-[64px] text-[#4D4D4D] text-center font-salernomi font-normal mb-6">
              Health & Wellness Astrology FAQs{" "}
            </h1>
            <svg
              width="49"
              height="24"
