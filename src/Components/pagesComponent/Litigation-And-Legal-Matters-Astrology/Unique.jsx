...
export default function Unique() {
  return (
    <div className="bg-[#F5F0EB] text-[#1E1E1E] min--screen p-10 max-md:p-4">
      <div className="heading flex mb-10 flex-col items-center justify-center">
        <h1 className="text-[64px] max-md:text-5xl text-[#4D4D4D] text-center font-salernomi w-[60%] max-xl:w-full font-normal mb-6">
          What Makes Our Legal Astrology Guidance Unique{" "}
        </h1>
        <svg
          width="49"
          height="24"
      ...
      <div className="flex items-center justify-center flex-wrap gap-4 pb-7">
        ...
        >
          ...
          <div className="text-center flex items-center justify-center mt-4 gap-3">
            <Image
              loading="lazy"
              src="/images/Ellipse 135 copy 7.png"
              width={80}
              height={80}
              alt="j"
            />
            <p className="text-2xl font-normal text-[#4D4D4D] font-inter text-left gap-3 max-md:text-[18px]">
              <span className="text-[#000]">Clear Direction —–</span> helps
              clients decide whether to fight, settle, or withdraw.
            </p>
          </div>
        </div>
        <div
        ...
        >
          ...
          <div className="text-center flex items-center justify-center mt-4 gap-3">
            <Image
              loading="lazy"
              src="/images/Ellipse 135 copy 6.png"
              width={80}
              height={80}
              alt="j"
            />
            <p className="text-2xl font-normal text-[#4D4D4D] font-inter text-left gap-3 max-md:text-[18px]">
              <span className="text-[#000]">Karma & Justice Insight —–</span>{" "}
              reveals the spiritual side of disputes.
            </p>
          </div>
        </div>
        <div
        ...
        >
          ...
          <div className="text-center flex items-center justify-center mt-4 gap-3">
            ...
            />{" "}
            <p className="text-2xl font-normal text-[#4D4D4D] font-inter text-left gap-3 max-md:text-[18px]">
              <span className="text-[#000]">Holistic Guidance —</span> both
              legal advice and astrological support.
            </p>
          </div>
        </div>
        <div
        ...
        >
          ...
          <div className="text-center flex items-center justify-center mt-4 gap-3">
            ...
            />{" "}
            <p className="text-2xl font-normal text-[#4D4D4D] font-inter text-left gap-3 max-md:text-[18px]">
              <span className="text-[#000]">Proven Experience —–</span> 20+
              years, 5,000+ consultations, successful property cases resolved.
            </p>
          </div>
        </div>
      </div>
