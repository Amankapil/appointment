    ...
    <div className="bg-[#fff] text-[#1E1E1E] min-hscreen p-10 py-20 max-md:p-4">
      <div className="heading flex mb-10 flex-col items-center justify-center">
        <h1 className="text-[64px] max-md:text-[40px] text-[#4D4D4D] text-center font-salernomi w-[60%] max-xl:w-full font-normal mb-6">
          How Astrology Assists in Litigation & Legal Matters{" "}
        </h1>
        <svg
          width="49"
          height="24"
      ...
      <div className="img h-[700px] max-md:h-full bgwhite flex items-center justify-center py-10">
        <Image
          ...
          height={400}
          loading="lazy"
          src="/images/Frame 337 copy 9.png"
          alt="j"
          className="h-[650px]"
        />
      </div>
      <div className="pr-4 max-lg:flex-wrap flex flex-col font-inter justify-center items-center mt-4 ">
        <p className="font-normal text-lg text-[#4D4D4D] w-1/2 max-lg:w-full  text-center">
          At Prashna Siddhi, we provide deep insights for handling legal
      ...
      <div className="lis  max-lg:p-8  pt-10 max-w-[846px] mx-auto space-y-4">
        ...
        >
          ...
          <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
            Chances of winning or losing a case.{" "}
        ...
        >
          ...
          <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
            The best time to file or appeal.{" "}
          </p>
        </div>
        ...
        >
          ...
          <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
            Whether to push for settlement or wait for judgment.{" "}
          </p>
        </div>
        ...
        >
          ...
          <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
            Remedies to reduce obstacles and speed up resolution.{" "}
          </p>
        </div>
        <div
          style={{ boxShadow: "0px 0px 24px 2px #AC8C6066 inset" }}
        ...
        >
          ...
          <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
            How planetary influences affect disputes and justice.{" "}
          </p>
        </div>
      </div>
      ...
      <div className="pr-4 max-lg:flex-wrap flex flex-col font-inter justify-center items-center mt-4 ">
        ...
        >
          Book Your Legal Astrology Consultation{" "}
        </Link>{" "}
      </div>
    </div>
  );
