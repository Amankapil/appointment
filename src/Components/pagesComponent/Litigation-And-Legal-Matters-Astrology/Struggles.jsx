    ...
    <>
      <div className="breaking mt-10">
        <h1 className="text-[56px] max-lg:text-[40px]  text-[#4D4D4D] text-center font-salernomi w-[100%] font-normal mb-6">
          Are These Legal Struggles Holding You Back?{" "}
        </h1>
        ...
        <div className="lis  max-lg:p-8  max-w-[846px] py-10 mx-auto space-y-4">
          ...
          >
            ...
            <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
              Fear of losing property or financial disputes?{" "}
            </p>
          </div>
          ...
          >
            ...
            <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
              Criminal accusations or false allegations?
            </p>
          </div>
          ...
          >
            ...
            <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
              Difficulty in getting justice or settlement?{" "}
            </p>
          </div>
        </div>
