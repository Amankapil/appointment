  ...
  return (
    <div className="bg-[#fff] text-[#1E1E1E] min-h-screen p-10 max-md:p-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="pr-4 max-lg:flex-wrap flex flexcol font-inter gap-10 justify-center items-start my-10 ">
          ...
          <div className="w-1/2 max-lg:w-full">
            <p className="font-normal text-lg text-[#4D4D4D] w  text-left">
              ...
              health and overall growth trajectory. Any significant afflictions
              to the Lagna can indicate health-related concerns, which can be
              analyzed through planetary influences such as Dasa, Bhukti, and
              Antara periods.
            </p>
            <p className="font-normal text-lg text-[#4D4D4D] w  text-left">
              However, Prashna Kundali—the art of answering questions based on
              the moment—can provide even deeper insights into potential medical
          ...
          <div className="w-1/2 max-lg:w-full">
            <div className="lis  max-lg:p-8  max-w-[846px] mx-auto space-y-4 pb-10">
              <p className="font-normal text-lg text-[#4D4D4D] w  text-left">
                ...
                Nodal Transit—a significant astrological phase where Rahu
                transits over Ketu and vice versa. This period often coincides
                with:
              </p>
              <div
              ...
              <p className="font-normal text-lg text-[#4D4D4D] w  text-left">
                Parents must remember that while this phase can be intense,
                astrology should not be applied rigidly. A holistic approach
                considering other planetary factors is essential.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="lis  max-lg:p-8  max-w-[846px] mx-auto space-y-4 pb-10">
              ...
              >
                ...
                <p className="text-xl font-inter text-center text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
                  ...
                  Jupiter returns to its natal position, bringing newfound
                  wisdom and a sense of individuality. This marks a phase where
                  children start developing their own perspectives and values.
                </p>
              </div>
              <div
                style={{ boxShadow: "0px 0px 24px 2px #AC8C6066 inset" }}
              ...
              >
                ...
                <p className="text-xl font-inter text-center text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
                  ...
                  Every year, the Ascendant progresses to a new house, but in
                  the 12th year, it returns to its birth position. This period
                  often signals deeper self- awareness and can be a pivotal
                  moment in a child’s personality development.
                </p>
              </div>

              <p className="font-normal text-lg text-[#4D4D4D] w  text-left">
                During this time, parents may observe a mix of independence,
                curiosity, and sometimes resistance—an expected phase of growth.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="pr-4 max-lg:flex-wrap flex flexcol font-inter gap-10 justify-center items-start my-10 ">
          ...
          <div className="w-1/2 max-lg:w-full">
            <div className="lis  max-lg:p-8  max-w-[846px] mx-auto space-y-4 pb-10">
              ...
              <p className="font-normal text-lg text-[#4D4D4D] w  text-left">
                Astrologically, this marks the Nodal Return—when Rahu and Ketu
                complete their first full revolution since birth. Rahu is often
                misunderstood as a purely negative influence, but in reality, it
                signifies karmic lessons and opportunities for growth. This
                period can feel transformative, with individuals experiencing:
              </p>
              <div
                style={{ boxShadow: "0px 0px 24px 2px #AC8C6066 inset" }}
                className="border-[1px] max-w-[826px] max-md:pl-8 max-w-826 border-[#AC8C60] items-center justify-center py-8 rounded-[24px] p-3 flex relative gap-10 font-inter bg-white shadow-md"
        ...
        <div className="pr-4 max-lg:flex-wrap flex flexcol max-md:hidden font-inter gap-10 justify-center items-start my-10 ">
          <svg
            width="1248"
