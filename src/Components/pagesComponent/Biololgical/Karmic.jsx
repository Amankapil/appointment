          ...
          <div className="pr-4 max-lg:flex-wrap flex flexcol font-inter gap-10 justify-center items-start my-10 ">
            ...
            <div className="w-1/2 max-lg:w-full">
              <p className="font-normal text-lg text-[#4D4D4D] w  text-left">
                The 18-year mark is not just about reaching legal adulthood—it
                is also a karmic checkpoint. According to Vedic wisdom, this
                phase updates an individual’s karmic balance, incorporating all
                actions since birth into the grand tapestry of their destiny.
              </p>
              <br />
              <p className="font-normal text-lg text-[#4D4D4D] w  text-left">
