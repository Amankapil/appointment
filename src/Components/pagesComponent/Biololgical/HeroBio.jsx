        ...
        <div className="pr-4 max-lg:flex-wrap flex flexcol font-inter gap-10 justify-center items-start my-10 ">
          ...
          <div className="w-1/2 max-lg:w-full">
            <p className="font-normal text-lg text-[#4D4D4D] w  text-left">
              Parenting comes with its share of concerns, especially when
              children display unique behavioral patterns during their formative
              years. Many parents find themselves wondering, Why is my child
              behaving this way? or What does this mean for their future?
            </p>
            <p className="font-normal text-lg text-[#4D4D4D] w  text-left">
              ...
              insights into the cosmic patterns that influence human
              development. This article is meant to provide clarity and
