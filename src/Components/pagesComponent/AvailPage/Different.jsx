    ...
    <>
      <div className="breaking my-10 max-xl:px-6">
        <h1 className="text-[56px] max-md:text-[40px] text-[#4D4D4D] text-center font-salernomi w-[100%] font-normal mb-6">
          What Makes Prashna Siddhi Different
        </h1>
        ...
        <div className="lis  max-lg:p-8 pt-10  max-w-[846px] mx-auto space-y-4">
          ...
          >
            ...
            <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
              Quick clarity for urgent decisions
          ...
          >
            ...
            <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
              Time-based, not person-based — 30 minutes can cover multiple
              family members
            </p>
          </div>
          ...
          >
            ...
            <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
              Optionally share your birth details (Name, Date, Time, Place) via
              WhatsApp
            </p>
          </div>
        </div>
