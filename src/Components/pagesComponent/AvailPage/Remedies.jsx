      ...
      <div className="breaking my-10 max-xl:px-6">
        ...
        {/* <div className="flex items-center flex-col w-[100%] mt-8  justify-center text-center">
          <p className="text-xl font-inter text-[#4D4D4D] mb8 w-1/2 max-xl:w-full ">
            {" "}
            Most astrology consultations rely on a birth chart. While useful, it
            requires exact details and can be time-consuming. At Prashna Siddhi,
            we specialize in Prashna Kundali (Horary Astrology), which gives
            precise answers based on the moment you ask a question.
          </p>
        </div> */}
        <div className="lis  max-lg:p-8 pt-10  max-w-[846px] mx-auto space-y-4">
          ...
          >
            ...
            <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
              Only zero-cost spiritual remedies suggested
            </p>
          </div>
          <div
            style={{ boxShadow: "0px 0px 24px 2px #AC8C6066 inset" }}
          ...
          >
            ...
            <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
              Shared through video + article links
            </p>
          </div>
          ...
          >
            ...
            <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
              We never sell paid remedies, products, or rituals
            </p>
          </div>
          ...
          >
            ...
            <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
              Clients may record the audio call for personal reference{" "}
            </p>
          </div>
          ...
          >
            ...
            <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
              All consultations are audio-only{" "}
            </p>
          </div>
        </div>
