...
import img from "./assets/image 39.png";
  ...
  return (
    <div className="bg-[#fff] text-[#1E1E1E] min-h-screen p-10 max-md:p-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="img h-[500px] max-xl:h-full flex items-center justify-center">
        ...
        <div className="pr-4 max-lg:flex-wrap flex flexcol font-inter gap-10 justify-center items-center my-10 ">
          ...
          <div className="w-1/2 max-xl:w-full">
            ...
            <p className="font-normal text-lg text-[#4D4D4D] w  text-center">
              This is where <span className="text-[#000]">Hora Lagna,</span>{" "}
              which moves twice as fast as the regular Lagna, plays a vital role
              in distinguishing their paths.
            </p>
            <p className="font-normal text-lg text-[#4D4D4D] w  text-center">
              If twins—born within minutes—can have drastically different fates,
              how can <span className="text-[#000]">millions of people</span>{" "}
              born within a 2.5-day Moon sign period share the same destiny?
            </p>
          </div>
        </div>
      </div>
