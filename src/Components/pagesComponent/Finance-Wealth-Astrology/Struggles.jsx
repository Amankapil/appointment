    ...
    <>
      <div className="breaking my-10 max-xl:px-6">
        ...
        <div className="lis  max-lg:p-8  max-w-[846px] mx-auto space-y-4">
          ...
          >
            ...
            <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
              Constant ups and downs in income or savings?{" "}
          ...
          >
            ...
            <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
              Hard work, but money slips away with no stability?{" "}
            </p>
          </div>
          ...
          >
            ...
            <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
              Stressed about debt, loans, or property disputes?{" "}
            </p>
          </div>
          ...
          >
            ...
            <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
              Unclear whether business, job, or investment is right for you?{" "}
            </p>
          </div>
          ...
          >
            ...
            <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
              Family wealth, inheritance, or joint finances causing tension?{" "}
            </p>
          </div>
          <div
            style={{ boxShadow: "0px 0px 24px 2px #AC8C6066 inset" }}
          ...
          >
            ...
            <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
              Fear about retirement, children’s future, or long-term security?{" "}
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center flex-col w-[100%] mt-8  justify-center text-center">
          ...
          >
            See What Your Chart RevealsFinancial
          </Link>{" "}
        </div>
      </div>
    </>
