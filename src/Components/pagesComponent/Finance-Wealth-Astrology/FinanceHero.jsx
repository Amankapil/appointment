    ...
    <div className="bg-[#F5F0EB] text-[#1E1E1E] min-hscreen p-10 py-20 max-md:p-4">
      <div className="heading flex mb-10 flex-col items-center justify-center">
        <h1 className="text-[64px] max-md:text-[40px] text-[#4D4D4D] text-center font-salernomi w-[60%] max-xl:w-full font-normal mb-6">
          Gain Clarity in Finance & Wealth with Astrology{" "}
        </h1>
        <svg
          width="49"
          height="24"
      ...
      <div className="img h-[450px] max-md:h-full bgwhite flex items-center justify-center py-10">
        <Image
          ...
          height={500}
          loading="lazy"
          src="/images/Frame 327 copy 3.png"
          alt="j"
        />
      </div>
      <div className="pr-4 max-lg:flex-wrap flex flex-col font-inter justify-center items-center mt-4 ">
        <p className="font-normal text-lg text-[#4D4D4D] w-1/2 max-lg:w-full  text-center">
          <span className="text-[#000]"></span> Discover how karmic patterns
          shape your money, growth, and financial stability. Do you feel
          uncertain about money, savings, or your financial future? Astrology
          reveals why wealth flows or gets blocked — and how you can align with
          abundance.
