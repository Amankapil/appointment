...
export default function Guidance() {
  return (
    <div className="bg-[#fff] text-[#1E1E1E] min-hscreen p-10 max-md:p-4 mt-20">
      <div className="heading flex mb-10 flex-col items-center justify-center">
        <h1 className="text-[56px] max-md:text-[40px] text-[#4D4D4D] text-center font-salernomi w-[100%] max-md:w-full font-normal mb-6">
          Real Guidance for Real Financial Concerns{" "}
        </h1>
        <svg
          width="49"
          height="24"
      ...
      <div className="img h-[450px] max-md:h-full bgwhite flex items-center justify-center py-10">
        <Image
          ...
          height={500}
          loading="lazy"
          src="/images/Frame 327 copy 4.png"
          alt="j"
        />
      </div>
        ...
        <div className="flex flex-wrap gap-15 max-md:gap-4 items-start justify-start py-10 max-w-[1280px] mx-auto">
          <div className="card1 gap-1 flex items-center w-[380px] max-md:w-full justify-start">
            ...
            <h1 className="text-[22px] max-md:text-[20px] text-left text-[#101010]  font-salernomi w[100%] max-md:w-full font-normal ">
              Sudden losses or unstable income{" "}
            </h1>
          </div>
          <div className="card1 gap-1 flex items-center w-[380px] max-md:w-full justify-start">
            <svg
            ...
            <h1 className="text-[22px] max-md:text-[20px] text-left text-[#101010]  font-salernomi w[100%] max-md:w-full font-normal ">
              Confusion about job vs. business{" "}
            </h1>
          </div>
          <div className="card1 gap-1 flex items-start w-[380px] max-md:w-full justify-start">
            ...
            <h1 className="text-[22px] max-md:text-[20px] text-left text-[#101010]  font-salernomi w[100%] max-md:w-full font-normal ">
              Property, inheritance, or joint family wealth disputes{" "}
            </h1>
          </div>
          <div className="card1 gap-1 flex items-center w-[380px] max-md:w-full justify-start">
            <svg
            ...
            <h1 className="text-[22px] max-md:text-[20px] text-left text-[#101010]  font-salernomi w[100%] max-md:w-full font-normal ">
              Loans, debts, or financial pressures{" "}
            </h1>
          </div>
          <div className="card1 gap-1 flex items-start w-[380px] max-md:w-full justify-start">
            <svg
          ...
          <div className="card1 gap-1 flex items-start w-[380px] max-md:w-full justify-start">
            ...
            <h1 className="text-[22px] max-md:text-[20px] text-left text-[#101010]  font-salernomi w[100%] max-md:w-full font-normal ">
              Partnerships and profit-sharing challenges{" "}
            </h1>
          </div>
          <div className="card1 gap-1 flex items-center w-[380px] max-md:w-full justify-start">
            <svg
            ...
            <h1 className="text-[22px] max-md:text-[20px] text-left text-[#101010]  font-salernomi w[100%] max-md:w-full font-normal ">
              Periods of abundance vs. scarcity{" "}
            </h1>
          </div>
        </div>
