    ...
    <div className="bg-[#F0EDE9] pt-20">
      <div className="heading flex mb-10 flex-col items-center justify-center">
        <h1 className="text-[64px] max-md:text-[40px] text-[#4D4D4D] text-center font-salernomi w-[100%] max-md:w-full font-normal mb-6">
          How to Use Siddhi-7 (Step-by-Step)
        </h1>
        <svg
          width="49"
          height="24"
      ...
      <div className="pr-4 max-lg:flex-wrap flex flexcol font-inter gap-10 justify-center items-start my-20 ">
        <h1 className="text-[40px] text-[#4D4D4D] text-left font-salernomi w-[40%] max-lg:w-full font-normal mb-6">
          Step 1: Choose How You Want to Consult
        </h1>
          ...
          <div className="lis  max-lg:p-8  max-w-[846px] mx-auto space-y-4 pb-10">
            ...
            >
              ...
              <p className="text-xl font-inter text-left text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
                <span className="text-[#000]">
                  {" "}
                  Live Phone Call (7-minute scheduled call)
                </span>{" "}
              </p>
            </div>
            <div
            ...
            >
              ...
              <p className="text-xl font-inter text-left text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
                <span className="text-[#000]">
                  {" "}
                  Voice Message Query (you record and send your question; we
                  send a voice answer)
                </span>{" "}
              </p>
            </div>
            <p className="font-normal text-lg text-[#4D4D4D] w  text-left">
              (Please select your preferred format on this page.)
            </p>
          </div>
        </div>
      </div>
