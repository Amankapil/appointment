...
const Enough = () => {
  return (
    <div className="bg-[#fff] pt-20">
      ...
      <div className="pr-4 max-lg:flex-wrap flex flexcol font-inter gap-10 justify-center items-center my-20 ">
        <div className="w-1/2 max-lg:w-full">
          <div className="lis  max-lg:p-8  max-w-[846px] mx-auto space-y-4 pb-10">
            <p className="font-normal text-lg text-center text-[#4D4D4D]">
              Many of our long-term clients — especially businesspeople —
              consult us regularly in short time slots for urgent matters
              across:
            </p>
            <div
              style={{ boxShadow: "0px 0px 24px 2px #AC8C6066 inset" }}
              className="border-[1px] max-w-[826px] max-md:pl-8 max-w-826 border-[#AC8C60] items-center justify-center py-8 rounded-[24px] px-10 flex relative gap-10 font-inter bg-white shadow-md"
            >
              ...
              <p className="text-xl font-inter text-center text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
                <span className="text-[#000]"> Finance</span>{" "}
              </p>
            </div>
            <div
              style={{ boxShadow: "0px 0px 24px 2px #AC8C6066 inset" }}
            ...
            >
              ...
              <p className="text-xl font-inter text-center text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
                <span className="text-[#000]"> Legal issues</span>{" "}
              </p>
            </div>
            <div
              style={{ boxShadow: "0px 0px 24px 2px #AC8C6066 inset" }}
            ...
            >
              ...
              <p className="text-xl font-inter text-center text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
                <span className="text-[#000]"> HR and staff management</span>{" "}
              </p>
            </div>
            <div
              style={{ boxShadow: "0px 0px 24px 2px #AC8C6066 inset" }}
            ...
            >
              ...
              <p className="text-xl font-inter text-center text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
                <span className="text-[#000]"> Competitor analysis</span>{" "}
              </p>
            </div>
            <div
              style={{ boxShadow: "0px 0px 24px 2px #AC8C6066 inset" }}
            ...
            >
              ...
              <p className="text-xl font-inter text-center text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
                <span className="text-[#000]">
                  {" "}
                  Personal and health guidance
                </span>{" "}
              </p>
            </div>
            <p className="font-normal text-lg text-[#4D4D4D] w  text-center">
              They have experienced that even 7 disciplined minutes can bring
              amazing clarity and peace when the question is sincere and
              focused.{" "}
            </p>
          </div>
        </div>
