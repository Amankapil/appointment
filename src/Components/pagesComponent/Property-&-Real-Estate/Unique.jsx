...
export default function Unique() {
  return (
    <div className="bg-[#F5F0EB] text-[#1E1E1E] minh-screen p-10 max-md:p-4">
      <div className="heading flex mb-10 flex-col items-center justify-center">
        <h1 className="text-[64px] max-md:text-5xl text-[#4D4D4D] text-center font-salernomi w-[60%] max-md:w-full font-normal mb-6">
          What Makes Our Guidance Unique{" "}
        </h1>
        <svg
          width="49"
          height="24"
      ...
      <div className="flex items-center justify-center flex-wrap gap-4 pb-7">
        ...
        >
          ...
          <div className="text-center flex items-center justify-center mt-4 gap-3">
            ...
            <p className="text-2xl font-normal text-[#4D4D4D] font-inter text-left gap-3 max-md:text-[18px]">
              <span className="text-[#000]">Focus on Safety —– </span> avoid
              fraud, disputes, or wrong deals.
            </p>
          </div>
        </div>
        <div
        ...
        >
          ...
          <div className="text-center flex items-center justify-center mt-4 gap-3">
            ...
            />
            <p className="text-2xl font-normal text-[#4D4D4D] font-inter text-left gap-3 max-md:text-[18px]">
              <span className="text-[#000]">Vastu + Astrology Together —–</span>{" "}
              for holistic property guidance.
            </p>
          </div>
        </div>
        <div
        ...
        >
          ...
          <div className="text-center flex items-center justify-center mt-4 gap-3">
            ...
            />{" "}
            <p className="text-2xl font-normal text-[#4D4D4D] font-inter text-left gap-3 max-md:text-[18px]">
              <span className="text-[#000]">Clarity for NRIs — </span> trusted
              support for property matters from abroad.
            </p>
          </div>
        </div>
        <div
