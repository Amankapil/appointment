    ...
    <div className="bg-[#F5F0EB] text-[#1E1E1E] min-hscreen p-10 max-md:p-4 py-20">
      <div className="heading flex mb-10 flex-col items-center justify-center">
        <h1 className="text-[64px] max-md:text-[40px] text-[#4D4D4D] text-center font-salernomi w-[60%] max-md:w-full font-normal mb-6">
          Unlock Property & Real Estate Success with Astrology{" "}
        </h1>
        <svg
          width="49"
          height="24"
      ...
      <div className="pr-4 max-lg:flex-wrap flex flex-col font-inter justify-center items-center mt-10 ">
        <p className="font-normal text-lg text-[#4D4D4D] w-1/2 max-lg:w-full  text-center">
          Guidance for buying, selling, disputes, and vastu harmony. Are you
          facing delays, disputes, or confusion in real estate matters?
          Astrology reveals the right time and direction for secure property
          investments.
        </p>
        <Link
          href="/booking"
