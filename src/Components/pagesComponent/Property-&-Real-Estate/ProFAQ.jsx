...
const faqs = [
  {
    question: "Can astrology predict when I will own a house?",
    answer: `Yes, astrology clearly shows property ownership periods and favorable timings.`,
    audio: "/propertyFAQ/A-1.mp3",
  },
  {
    question: "Can it resolve property disputes?",
    answer:
      "Yes, astrology highlights the cause and timing of resolution, along with practical actionable remedies.",
    audio: "/propertyFAQ/A-2.mp3",
  },
  {
    question: "Does vastu really matter in property?",
    answer:
      "Vaastu should not be viewed from faith or belief perspective. Look at from a practical point of view.",
    audio: "/propertyFAQ/A-3.mp3",
  },
  {
    question: "Should I consult before registering property?",
    answer:
      "Though, every Muhurath is fixed right at our first breath, you can be practical in ascertaining several factors impacting your major decisions.",
    audio: "/propertyFAQ/A-4.mp3",
  },
  {
    question: "Can astrology prevent fraud in property deals?",
    answer: `Yes, charts often reveal hidden risks and help avoid wrong deals.`,
    audio: "/propertyFAQ/A-5.mp3",
  },
  {
    question:
      "I live abroad. Can astrology guide my Indian property investments? ",
    answer:
      "Yes, many NRIs rely on astrology for safe and profitable decisions.",
    audio: "/propertyFAQ/A-6.mp3",
  },
  {
    question:
      "Does astrology suggest what type of property is suitable for me? ",
    answer:
      "Yes, it can indicate whether land, house, or commercial space suits your destiny.",
    audio: "/propertyFAQ/A-7.mp3",
  },
  {
    question: "Why do my property deals always get delayed?",
    answer:
      "Delays are often karmic. Astrology shows the right time when blockages clear.",
    audio: "/propertyFAQ/A-8.mp3",
  },
  {
    question: "Can astrology help with loans for property purchase?",
    answer: `Yes, it shows financial stability and favorable periods for loans.`,
    audio: "/propertyFAQ/A-9.mp3",
  },
  {
    question: "Does vastu correction really work without demolition?",
    answer:
      "Any remedy is subject to destiny only. You can rely on Vedic Prashna Kundali where several Bhavas can be analysed simultaneously to guide you.",
    audio: "/propertyFAQ/A-10.mp3",
  },
];
