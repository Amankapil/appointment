      ...
      <div className="lis  max-lg:p-8  pt-10 max-w-[846px] mx-auto space-y-4">
        ...
        >
          ...
          <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
            Understand the Karmic patterns behind challenges.{" "}
        ...
        >
          ...
          <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
            Discover the divine timing for progress and transformation.{" "}
          </p>
        </div>
        ...
        >
          ...
          <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
            Learn practical steps for harmony, growth, and stability.{" "}
          </p>
        </div>
        ...
        >
          ...
          <p className="text-xl font-inter text-[#4D4D4D] mb8 w-3/4 max-md:w-full ">
            Gain spiritual clarity to handle real-life problems with wisdom.{" "}
          </p>
        </div>
      </div>
