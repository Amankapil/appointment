  ...
  return (
    <div className="bg-[#F5F0EB] text-[#1E1E1E] min-hscreen p-10 max-md:p-4 py-20">
      <div className="heading flex mb-10 flex-col items-center justify-center">
        <h1 className="text-[64px] max-md:text-[40px] text-[#4D4D4D] text-center font-salernomi w-[60%] max-lg:w-full font-normal mb-6">
          Find Clarity in Career & Profession Astrology
        </h1>
        <svg
          width="49"
          height="24"
      ...
      <div className="img h-[450px] max-md:h-full bgwhite flex items-center justify-center py-10">
        <Image
          ...
          height={500}
          loading="lazy"
          src="/images/Frame 337 copy 2.png"
          alt="j"
        />
      </div>
      <div className="pr-4 max-lg:flex-wrap flex flex-col font-inter justify-center items-center mt-4 ">
        <p className="font-normal text-lg text-[#4D4D4D] w-1/2 max-lg:w-full  text-center">
          <span className="text-[#000]"></span> Astrology that reveals guidance,
          timing, and solutions for career & profession astrology. Confused
          about challenges in this area of life? You don’t have to walk this
          journey alone.
        ...
        <Link
          href="/booking"
          className="bg-[#101010] text-[20px] font-salernomi mt-10 text-white px-[24px] py-[12px] rounded hover:bg-[#333333] transition-all duration-300 shadow-button"
        >
