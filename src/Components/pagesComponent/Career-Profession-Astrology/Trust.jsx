  ...
  return (
    <div className="bg-[#F5F0EB] text-[#1E1E1E] min-h-screen p-10 max-md:p-4">
      <div className="heading flex mb-10 flex-col items-center justify-center">
        <h1 className="text-[56px] max-md:text-[40px] text-[#4D4D4D] text-center font-salernomi w-[60%] max-xl:w-full font-normal mb-6">
          Why People Trust Prashna Siddhi for Career & Profession Astrology
        </h1>
        <svg
          width="49"
          height="24"
      ...
      <div className="flex items-center justify-center flex-wrap gap-4 pb-7">
        ...
        >
          ...
          <div className="text-center flex items-center justify-center mt-4 gap-3">
            ...
            <p className="text-2xl font-normal text-[#4D4D4D] font-inter text-left gap-3 max-md:text-[18px]">
              <span className="text-[#000]">Beyond routine astrology —– </span>{" "}
              we uncover the root causes, not just surface formulas.
            </p>
          </div>
        </div>
        <div
        ...
        >
          ...
          <div className="text-center flex items-center justify-center mt-4 gap-3">
            <Image
              loading="lazy"
              src="/images/Ellipse 135 copy.png"
              width={80}
              height={80}
              alt="j"
            />
            <p className="text-2xl font-normal text-[#4D4D4D] font-inter text-left gap-3 max-md:text-[18px]">
              ...
              clarity you can apply immediately, not ritual-based remedies.
            </p>
          </div>
        </div>
        <div
        ...
        >
          ...
          <div className="text-center flex items-center justify-center mt-4 gap-3">
            <Image
              loading="lazy"
              src="/images/Ellipse 135 (1).png"
              width={80}
              height={80}
              alt="j"
            />{" "}
            <p className="text-2xl font-normal text-[#4D4D4D] font-inter text-left gap-3 max-md:text-[18px]">
              <span className="text-[#000]">Respect for Every Question —</span>{" "}
        ...
        >
          ...
          <div className="text-center flex items-center justify-center mt-4 gap-3">
            ...
            />{" "}
            <p className="text-2xl font-normal text-[#4D4D4D] font-inter text-left gap-3 max-md:text-[18px]">
              <span className="text-[#000]">Trusted Experience —–</span> 50+
              years of guidance, 5,000+ consultations delivered.
            </p>
          </div>
        </div>
      </div>
